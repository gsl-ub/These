...
\setmainfont{RobotoSerif}[% Le nom exact peut dépendre du système, vérifiez les fichiers .ttf/.otf
  ...
  %FontFace = {b}{n}{*-SemiBold},          % \bfseries → SemiBold
  %FontFace = {b}{it}{*-SemiBoldItalic},   % \bfseries\itshape → SemiBoldItalic
  %FontFace = {m}{n}{*-Light},             % \mdseries → Light
  %FontFace = {m}{it}{*-LightItalic},       % \mdseries\itshape → LightItalic
  Extension=.ttf
]
...
%\renewcommand{\chaptitlefont}{\titrefont\Huge\bfseries}
%\setsecheadstyle{\titrefont\Large\bfseries} % section
%\setsubsecheadstyle{\titrefont\large\bfseries} % sous-section
%\setsubsubsecheadstyle{\titrefont\normalsize\bfseries}
